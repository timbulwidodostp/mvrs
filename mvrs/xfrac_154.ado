...
// PR 22mar2009 -start-
	...
	if "`sequential'"=="" {		// default is closed-test-style presentation
		local n1_0 = (`k' + 1) * `degree' + `k' * `cz' // model df for highest-degree fp model
		local n2 = e(fp_rdf) - `n1_0' // residual df for highest-degree fp model
...
// PR deletion 14May2017: `n2' does not change since most complex model does not change
